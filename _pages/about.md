...
His research centers on two interconnected theoretical frameworks. The first, Aethic Reasoning, proposes a new logical-informational approach to the quantum measurement problem, deriving the collapse postulate from three foundational postulates rather than assuming it. The second, [Nexic Reasoning](https://philpapers.org/rec/BENNRD), extends anthropic reasoning from physical constants to circumstantial historical events, yielding a formal calculus over natural history with applications to paleontology and the Fermi paradox. His main publication, [*Aethic Reasoning: A Comprehensive Solution to the Quantum Measurement Problem* (PhilArchive, 2024)](https://philpapers.org/rec/BENARA-5), has accumulated over 3,600 downloads since its release, placing its downloads count in the last six months among the top 0.01% of items on the server.
...
He is currently working on Active Reasoning, which aims to derive the Born rule and connect the Aethic postulates to quantitative quantum mechanics. The Quantum Nexus integral serves as the initiation of this further research. Outside of research, Ajax is interested in video production, science communication, and spending unreasonable amounts of time staring at Mach-Zehnder interferometer animations.
